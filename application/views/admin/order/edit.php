            ...
            <table class="table table-hover" id="table-order-detail">
                ...
                <?php 
                    ...
                    <tr id="order_detail_<?php echo $rs->id; ?>">
                        ...
                        <td><input type="text" name="amount" class="form-control" id="exampleInputEmail1" value="<?php echo $rs->amount; ?>" placeholder="Số lượng sản phẩm"></td>
                        <td><?php echo $rs->price; ?></td>
                        <td><?php echo $rs->pamount; ?></td>

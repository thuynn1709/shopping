<!--
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" role="form" name="submit" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/login/login') ; ?>">
                ...
                <input type="email" name="email" id="inputEmail" class="form-control" value="<?php echo set_value('email'); ?>" placeholder="Email address" required autofocus>
